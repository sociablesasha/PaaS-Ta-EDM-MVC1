...
<div class="box_type">
    <div class="top__menu__cover">
        <ul class="tab_box">
            <li class="on"><a href="/index.jsp"><strong>공모전 안내</strong></a></li>
    ...
    <div class="cont">
        <img src="/image/main.jpg" alt="sample" border="0">
    </div>
</div>
<script>
    // POPUP
    ...
    //     var popOption = "width:560px, height:730px, resizable=no, scrollbars=no, status=no, directories: no, location:no, menubar:no, toolbar:no;";
